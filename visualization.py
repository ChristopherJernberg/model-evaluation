...
class DetectionVisualizer:
    ...
    def draw_boxes(self, frame: np.ndarray, boxes: List[BoundingBox | Detection], color: tuple[int, int, int]) -> np.ndarray:
    ...
    def create_comparison_frame(
        ...
        for frame_img in [gt_frame, pred_frame]:
            cv2.rectangle(frame_img,
                         ...
                         bg_color,
                         -1)
            cv2.putText(frame_img, frame_label,
                       (50, frame_y),
        ...
        cv2.rectangle(combined_frame,
                     ...
                     bg_color,
                     -1)
        cv2.putText(combined_frame, self.model_name,
